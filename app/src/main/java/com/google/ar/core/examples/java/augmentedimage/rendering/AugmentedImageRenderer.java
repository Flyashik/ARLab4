...
public class AugmentedImageRenderer {
  ...
  public void draw(
    ...
    andyRenderer.updateModelMatrix(modelMatrix, 0.05f, mazeScaleFactor / 10.0f, mazeScaleFactor); // 0.05f is a Magic number to scale
    ...
    andyRenderer.updateModelMatrix(modelMatrix, 0.05f, mazeScaleFactor / 10.0f, mazeScaleFactor);
    andyRenderer.draw(viewMatrix, projectionMatrix, colorCorrectionRgba, tintColor);
  }
